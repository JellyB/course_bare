...
import com.huatu.tiku.course.netschool.api.fall.HtmlServiceFallbackFactory;
 ...
 */
@FeignClient(value = "course-service",fallbackFactory = HtmlServiceFallbackFactory.class)
