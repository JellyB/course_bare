...
data_dir=/Users/biguodong/Documents/workspace/huatu/course-server
START_TIME=`date +%s`
WORKSPACE=${data_dir}/workspace/
git_url=git@123.103.86.53:tiku/course-server.git
project_name=course-web-server
git_branch=v2.1.6.4
module=course-web-server
profile=dev
